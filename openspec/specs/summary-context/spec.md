# summary-context Specification

## Purpose

Let the user supply free-form context for a recording (speaker identities, topics, acronyms) that is persisted with the recording and injected into the summary step to improve summary accuracy, without affecting transcription or triage.
